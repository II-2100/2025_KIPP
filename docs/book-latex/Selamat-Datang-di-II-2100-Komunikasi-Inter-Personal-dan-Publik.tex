...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacityback=0, colback=white, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, coltitle=black, left=2mm, toptitle=1mm, rightrule=.15mm, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, breakable, opacitybacktitle=0.6, bottomtitle=1mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacityback=0, colback=white, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Penugasan Peer Assignmen Baru Ada Nanti Saat UTS}, coltitle=black, left=2mm, toptitle=1mm, rightrule=.15mm, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, breakable, opacitybacktitle=0.6, bottomtitle=1mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacityback=0, colback=white, titlerule=0mm, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, coltitle=black, left=2mm, toptitle=1mm, rightrule=.15mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, breakable, opacitybacktitle=0.6, bottomtitle=1mm, toprule=.15mm]
