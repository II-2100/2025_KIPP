...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, coltitle=black, bottomtitle=1mm, left=2mm, rightrule=.15mm, colback=white, breakable, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, arc=.35mm, opacitybacktitle=0.6]
