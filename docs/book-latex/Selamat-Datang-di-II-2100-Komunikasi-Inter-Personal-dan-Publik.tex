...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, opacityback=0, colback=white, toprule=.15mm, arc=.35mm, coltitle=black, left=2mm, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, breakable, bottomrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, leftrule=.75mm, rightrule=.15mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, opacityback=0, colback=white, toprule=.15mm, arc=.35mm, coltitle=black, left=2mm, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, breakable, bottomrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, leftrule=.75mm, rightrule=.15mm, titlerule=0mm]
