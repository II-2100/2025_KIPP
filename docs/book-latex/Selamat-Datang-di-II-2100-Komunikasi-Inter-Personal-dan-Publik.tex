...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, leftrule=.75mm, breakable, bottomrule=.15mm, left=2mm, coltitle=black, arc=.35mm, toprule=.15mm, colback=white, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, leftrule=.75mm, breakable, bottomrule=.15mm, left=2mm, coltitle=black, arc=.35mm, toprule=.15mm, colback=white, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Penugasan Peer Assignmen Baru Ada Nanti Saat UTS}, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, leftrule=.75mm, breakable, bottomrule=.15mm, left=2mm, coltitle=black, arc=.35mm, toprule=.15mm, colback=white, colframe=quarto-callout-important-color-frame, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, rightrule=.15mm]
