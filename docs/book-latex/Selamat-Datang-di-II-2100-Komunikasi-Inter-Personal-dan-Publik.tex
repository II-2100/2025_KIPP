...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, leftrule=.75mm, titlerule=0mm, breakable, opacityback=0, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colbacktitle=quarto-callout-warning-color!10!white, bottomtitle=1mm, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, coltitle=black, arc=.35mm, colback=white, toprule=.15mm, left=2mm]
...
\addcontentsline{toc}{subsection}{UTS-2 Song for you}
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, leftrule=.75mm, titlerule=0mm, breakable, opacityback=0, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, coltitle=black, arc=.35mm, colback=white, toprule=.15mm, left=2mm]
...
\chapter{Laporan UTS}\label{laporan-uts}

\emph{Dibuat: 2025-10-14 11:11:55 WIB}

\begin{itemize}
\tightlist
\item
  Total mahasiswa: \textbf{73}
\item
  Sudah submit: \textbf{2}
\item
  Belum submit: \textbf{71}
\end{itemize}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.0704}}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.6620}}@{}}
\toprule\noalign{}
...
\section{Daftar Belum Submit}\label{daftar-belum-submit}
...
\item
  ...
  \tightlist
  \item
    Ulivia Embun Tresna Wardani (10322015)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Felissha Dunell Damanik (18223099)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Muhammad Dhafin Faidhulhaq (18223103)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Keira Amelie Hanayesha (18224003)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Evan Nathanael Tanuri (18224019)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Muhammad Okto Huzainy (18224021)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Ahmad Aditya Ar Rasyid (18224023)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Stella Cometta Febriana (18224035)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Aldyto Rafif Abhinaya (18224043)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Muthia Ariesta Anggraeni (18224045)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Daniel Benaya Toar Supaath (18224047)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Belva Charissa Putri Have (18224051)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Nathan Pasha Athallah (18224053)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Adrian Akhdan Assyauqi (18224055)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Levina Nathania Bunardi (18224057)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Tiara Kusuma Wardhani (18224059)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Yumna Fathonah Kautsar (18224063)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Benedicta Sherin Chyntia Putri (18224065)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Bryant Azraqi Mohammad (18224067)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Naufalziyadh Alif Bintang S (18224077)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Abhinaya Rajendra Fargaz (18224087)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Muhammad Azikra Wira Pratama (18224089)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Haidarrozan Pramasony (18224103)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Laurensius Dani Rendragraha (18224107)
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Adriel Nathanael Simatupang (18224109)
  \end{enumerate}
\end{itemize}
